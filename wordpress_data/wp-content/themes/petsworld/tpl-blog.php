...
get_header();
	...
	switch ( $page_layout ) {
		case 'with-left-sidebar':
			...
			$sidebars = petsworld_check_sidebar( 'page', $post->ID, 'left' );
		...
		case 'with-right-sidebar':
			...
			$sidebars = petsworld_check_sidebar( 'page', $post->ID, 'right' );
		...
		case 'with-both-sidebar':
			...
			$sidebars = array_merge( petsworld_check_sidebar( 'page', $post->ID, 'left' ) , petsworld_check_sidebar( 'page', $post->ID, 'right' ) );
    ...
    <section id="primary" class="<?php echo esc_attr( $page_layout ); ?>"><?php
                        ...
                        <?php if( $post_style == "entry-date-left"): ?>
                                ...
                                <div class="entry-details">
                                    ...
                                    <?php if( array_key_exists('blog-post-excerpt',$tpl_default_settings) && array_key_exists('blog-post-excerpt-length',$tpl_default_settings) ):?>
                                    		<div class="entry-body"><?php echo petsworld_excerpt($tpl_default_settings['blog-post-excerpt-length']); ?></div>
                                   <?php endif;?>
        ...
        <!-- **Pagination** -->
        <div class="pagination blog-pagination"><?php echo petsworld_pagination($the_query); ?></div><!-- **Pagination** -->
        <!-- Blog Template Ends -->
