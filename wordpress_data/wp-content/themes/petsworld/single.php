<?php get_header();
	...
	switch ( $page_layout ) {
		...
		case 'with-left-sidebar':
			...
			$sidebars = petsworld_check_sidebar( 'post', $post->ID, 'left' );
		...
		case 'with-right-sidebar':
			...
			$sidebars = petsworld_check_sidebar( 'post', $post->ID, 'right' );
		...
		case 'with-both-sidebar':
			...
			$sidebars = array_merge( petsworld_check_sidebar( 'post', $post->ID, 'left' ) , petsworld_check_sidebar( 'post', $post->ID, 'right' ) );
