...
<div id="item-actions">
	...
	<?php if ( bp_group_is_visible() ) : ?>
		...
		if ( bp_group_has_moderators() ) :
			...
			<h3><?php esc_html_e( 'Group Mods' , 'petsworld' ); ?></h3>
...
<div id="item-header-content">
	...
	<span class="activity"><?php printf( esc_html__( 'active %s', 'petsworld' ), bp_get_group_last_active() ); ?></span>
	...
	<h3><?php esc_html_e( 'Group Admins', 'petsworld' ); ?></h3>
