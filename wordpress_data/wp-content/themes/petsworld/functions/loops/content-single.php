...
<article id="post-<?php the_ID(); ?>" <?php post_class($post_classes); ?>>
	...
	<?php if( $post_style == "entry-date-left"):?>
			...
			<div class="entry-details">
				...
				<?php edit_post_link( esc_html__( ' Edit ','petsworld' ) ); ?>
			</div><!-- .entry-details -->
			...
			<div class="entry-details">
				...
				<div class="entry-meta">
					...
					<div class="author <?php echo esc_attr( $show_author_meta ); ?>">
						/ <i class="pe-icon pe-user"> </i>
						<a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>" title="<?php esc_attr_e('View all posts by ', 'petsworld'); echo get_the_author(); ?>">
...
<?php # Post Author Information Box
	$post_author_box = petsworld_option('pageoptions','single-post-authorbox');
	if( isset($post_author_box) ):?>
		<div class="dt-sc-hr"></div>
		<div class="dt-sc-clear"></div>
		<section class="author-info">
        	<h2><?php esc_html_e('About Author','petsworld'); ?></h2>
			<div class="thumb">
...
<?php endif;
	...
	# Related Posts
	$related_post = petsworld_option('pageoptions','single-post-related');
	...
	#Post Comments
	$post_comment = petsworld_option('pageoptions','single-post-comments');
