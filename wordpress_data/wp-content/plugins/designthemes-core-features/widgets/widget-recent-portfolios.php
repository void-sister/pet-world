<?php
class PetsWorld_Portfolio_Widget extends WP_Widget {
	#1.constructor
	function __construct() {
		$widget_options = array("classname"=>'widget_popular_entries', 'description'=>__('To list out portfolio items', 'petsworld'));
		parent::__construct(false,THEME_NAME.' '.__('Portfolio','petsworld'),$widget_options);
	}
	...
	function widget($args, $instance) {
		...
		echo "<div class='recent-portfolio-widget'><ul>";
			 ...
			 if($the_query->have_posts()) :
			 	...
			 	echo "<li>".__('No Portfolio Entries found','petsworld')."</li>";
			 endif;
			 wp_reset_postdata();
	 	echo "</ul></div>";			 
		echo ($after_widget);
