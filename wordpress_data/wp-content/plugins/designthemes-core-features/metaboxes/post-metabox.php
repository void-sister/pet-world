<?php
	#Post Meta Box
	add_action("add_meta_boxes", "petsworld_post_metabox");
	add_action('save_post','petsworld_post_meta_save');
	function petsworld_post_metabox(){
		add_meta_box("post-template-meta-container", __('Post Options', 'petsworld'), "petsworld_post_settings","post", "normal", "default");
		add_meta_box("post-format-meta-container",__('Post Format Options', 'petsworld'),"petsworld_post_format_settings","post","normal","default");
	}

	function petsworld_post_settings($args){
		global $post;
        ...
        <div id="page-layout" class="custom-box">
			...
			<div class="column five-sixth last">  
                ...
                <p class="note"> <?php _e("You can choose a perfect layout for your post", 'petsworld');?> </p>
            </div>
        </div><!-- Layout End-->
        ...
        <div class="custom-box">
			<div class="column one-sixth">
        	    <label><?php _e('Show Featured Image', 'petsworld');?></label>
            </div>
			<div class="column five-sixth last">
                ...
                <p class="note"> <?php _e('YES! to show featured image', 'petsworld');?> </p>
            </div>
        </div><!-- Featured Image Section End--><?php
		wp_reset_postdata();
    }
	
    function petsworld_post_format_settings( $args ) {
        global $post; 
        $tpl_default_settings = get_post_meta($post->ID,'_dt_post_settings',TRUE);
        $tpl_default_settings = is_array($tpl_default_settings) ? $tpl_default_settings  : array(); ?>
        ...
        <div id="dt-post-format-gallery">
            <div class="custom-box">
                <div class="column one-sixth"><label><?php _e('Image Gallery', 'petsworld');?> </label></div>
                <div class="column five-sixth last">
                    <div class="dt-media-btns-container">
                        <a href="#" class="dt-open-media-for-gallery-post button button-primary"><?php _e( 'Click Here to Add Images', 'petsworld' );?></a>
                    </div>
                    <div class="clear"></div>
        ...
        <div id="dt-post-format-video-audio">
            <div class="custom-box">
                <div class="column one-sixth"><label><?php _e('oEmbed URL', 'petsworld');?> </label></div>
                <div class="column five-sixth last">
                    ...
                    <p class="note"><?php _e("Enter a URL that is compatible with WP's built-in oEmbed feature. This setting is used for your video and audio post formats.", 'petsworld');?></p>
                </div>
            </div>

            <div class="custom-box">
                <div class="column one-sixth"><label><?php _e('Self Hosted URL', 'petsworld');?> </label></div>
                <div class="column five-sixth last">
                    ...
                    <p class="note"><?php _e("Insert your self hosted video or audio url here.", 'petsworld');?></p>                    
                </div>
            </div>
        </div><?php
    }
	
	function petsworld_post_meta_save($post_id){
