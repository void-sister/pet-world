<?php global $post;
$pet_shelter_settings = get_post_meta ( $post->ID, '_custom_settings', TRUE );
$pet_shelter_settings = is_array ( $pet_shelter_settings ) ? $pet_shelter_settings : array ();
echo '<input type="hidden" name="dt_theme_pet_shelter_meta_nonce" value="'.wp_create_nonce('dt_theme_pet_shelter_nonce').'" />'; ?>

<!-- Phone -->
<div class="sub-title custom-box">
    <div class="column one-sixth"><?php
        esc_html_e( 'Phone','petsworld-core');
        $phone = array_key_exists ( 'phone', $pet_shelter_settings ) ? $pet_shelter_settings ['phone'] : '';
        ?></div>
    <div class="column five-sixth last">
        <input name="phone" type="text" class="small" value="<?php echo esc_attr($phone);?>"/>
    </div>
</div>
<!-- Phone -->
...
<div class="sub-title custom-box">
    <div class="column one-sixth"><?php
        esc_html_e( 'Owner Name','petsworld-core');
        $owner_name = array_key_exists ( 'owner_name', $pet_shelter_settings ) ? $pet_shelter_settings ['owner_name'] : '';
        ?></div>
    <div class="column five-sixth last">
        <input name="owner_name" type="text" class="medium" value="<?php echo esc_attr($owner_name);?>"/>
    </div>
</div>
<!-- Owner Name -->
...
<div class="sub-title custom-box">
    <div class="column one-sixth"><?php
        esc_html_e( 'Address','petsworld-core');
        $address = array_key_exists ( 'address', $pet_shelter_settings ) ? $pet_shelter_settings ['address'] : '';
        ?></div>
    <div class="column five-sixth last">
        <input name="address" type="text" class="medium" value="<?php echo esc_attr($address);?>"/>
    </div>
</div>
<!-- Address -->
...
<div class="sub-title custom-box">
    <div class="column one-sixth"><?php
        esc_html_e( 'Website Link','petsworld-core');
        $website_link = array_key_exists ( 'website_link', $pet_shelter_settings ) ? $pet_shelter_settings ['website_link'] : '';
        ?></div>
    <div class="column five-sixth last">
        <input name="website_link" type="text" class="medium" value="<?php echo esc_attr($website_link);?>"/>
    </div>
</div>
<!-- Website -->
...
<div class="sub-title custom-box">
    <div class="column one-sixth"><?php
        esc_html_e( 'Instagram Link','petsworld-core');
        $instagram_social_link = array_key_exists ( 'instagram_social_link', $pet_shelter_settings ) ? $pet_shelter_settings ['instagram_social_link'] : '';
        ?></div>
    <div class="column five-sixth last">
        <input name="instagram_social_link" type="text" class="medium" value="<?php echo esc_attr($instagram_social_link);?>"/>
    </div>
</div>
<!-- Instagram -->
...
<div class="sub-title custom-box">
    <div class="column one-sixth"><?php
        ...
        $facebook_social_link = array_key_exists ( 'facebook_social_link', $pet_shelter_settings ) ? $pet_shelter_settings ['facebook_social_link'] : '';
        ?></div>
    <div class="column five-sixth last">
...
<div class="sub-title custom-box">
    ...
    <div class="column five-sixth last">
        <div class="two-third column image-preview-container" style="width:60%;">
            <?php $subtitlebg = array_key_exists ( 'sub-title-bg', $pet_shelter_settings ) ? $pet_shelter_settings ['sub-title-bg'] : '';?>
        ...
        <div class="one-third column last">
            ...
            <?php $opacity =  array_key_exists ( "sub-title-opacity", $pet_shelter_settings ) ? $pet_shelter_settings ['sub-title-opacity'] : ''; ?>
...
<div class="sub-title custom-box">
    ...
    <div class="column five-sixth last">
        <div class="column one-third">
            ...
            <?php $bgrepeat =  array_key_exists ( "sub-title-bg-repeat", $pet_shelter_settings ) ? $pet_shelter_settings ['sub-title-bg-repeat'] : ''; ?>
            <div class="clear"></div>
        ...
        <div class="column one-third">
            ...
            <?php $bgposition =  array_key_exists ( "sub-title-bg-position", $pet_shelter_settings ) ? $pet_shelter_settings ['sub-title-bg-position'] : ''; ?>
            <div class="clear"></div>
        ...
        <div class="column one-third last">
            ...
            $value =  	array_key_exists ( 'sub-title-bg-color', $pet_shelter_settings ) ? $pet_shelter_settings ['sub-title-bg-color'] : '';
...
<div id="page-layout" class="custom-box">
    ...
    <div class="column five-sixth last">
        <ul class="bpanel-layout-set"><?php
            ...
            $v =  array_key_exists("layout",$pet_shelter_settings) ?  $pet_shelter_settings['layout'] : 'content-full-width';
...
<?php
$sb_layout = array_key_exists("layout",$pet_shelter_settings) ? $pet_shelter_settings['layout'] : 'content-full-width';
...
<div id="widget-area-options" <?php echo $sidebar_both;?>>
    <div id="left-sidebar-container" class="page-left-sidebar" <?php echo $sidebar_left; ?>>
        ...
        <div id="page-commom-sidebar" class="sidebar-section custom-box">
            ...
            <div class="column five-sixth last"><?php
                $switchclass = array_key_exists("show-standard-sidebar-left",$pet_shelter_settings) ? 'checkbox-switch-on' :'checkbox-switch-off';
                $checked = array_key_exists("show-standard-sidebar-left",$pet_shelter_settings) ? ' checked="checked"' : '';?>
        ...
        <div id="page-sidebars" class="sidebar-section custom-box page-widgetareas">
            ...
            <div class="column five-sixth last"><?php
                $widgetareas = array_key_exists("widget-area-left",$pet_shelter_settings) ? array_unique($pet_shelter_settings["widget-area-left"]) : array();
    ...
    <div id="right-sidebar-container" class="page-right-sidebar" <?php echo $sidebar_right; ?>>
        ...
        <div id="page-commom-sidebar" class="sidebar-section custom-box page-right-sidebar">
            ...
            <div class="column five-sixth last"><?php
                $switchclass = array_key_exists("show-standard-sidebar-right",$pet_shelter_settings) ? 'checkbox-switch-on' :'checkbox-switch-off';
                $checked = array_key_exists("show-standard-sidebar-right",$pet_shelter_settings) ? ' checked="checked"' : '';?>
        ...
        <div id="page-sidebars" class="sidebar-section custom-box page-widgetareas">
            ...
            <div class="column five-sixth last"><?php
                $widgetareas = array_key_exists("widget-area-right",$pet_shelter_settings) ? array_unique($pet_shelter_settings["widget-area-right"]) : array();
                $widgets = petsworld_option('widgetarea','custom');?>
    ...
    <div class="column five-sixth last">
        ...
        <div class="dt-media-container">
            <ul class="dt-items-holder"><?php
                if (array_key_exists ( "items", $pet_shelter_settings )) {
                    foreach ( $pet_shelter_settings ["items_thumbnail"] as $key => $thumbnail ) {
                        $item = $pet_shelter_settings ['items'] [$key];
                        $out = "";
                        $name = "";
                        ...
                        if (in_array ( $ext, $foramts )) {
                            $name = $pet_shelter_settings ['items_name'] [$key];
                            $out .= "<li>";
