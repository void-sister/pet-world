...
<div id="portfolio-layout" class="custom-box">
	<div class="column one-sixth">
		<label><?php esc_html_e('Portfolio Layout','petsworld-core');?> </label>
	</div>
	<div class="column five-sixth last">
		...
		<p class="note"> <?php esc_html_e("You can choose between a left, right or full width portfolio layout.",'petsworld-core');?> </p>
	</div>
...
<div class="custom-box">
	<div class="column one-sixth">
		<label><?php esc_html_e('Masonry Size','petsworld-core');?> </label>
	</div>
	<div class="column five-sixth last">
		...
		<select name="masonry-size" class="dt-chosen-select">
			<?php  $array = array(
				'' => __('Default','petsworld-core'),
				'grid-sizer-1' => __('Grid Size 1','petsworld-core'),
				'grid-sizer-2' => __('Grid Size 2','petsworld-core'),
				'grid-sizer-3' => __('Grid Size 3','petsworld-core'),
				'grid-sizer-4' => __('Grid Size 4','petsworld-core'),
				'grid-sizer-5' => __('Grid Size 5','petsworld-core'));

			foreach( $array as $k => $v): ?>
				<option value="<?php echo esc_attr($k);?>" <?php selected($k,$masonry);?>><?php echo esc_attr($v);?></option>
			<?php endforeach;?>
		</select>
        <p class="note"> <?php esc_html_e("It works with portfolio infinite shortcode only",'petsworld-core');?> </p>
	</div>	
</div><!-- Masonry Size -->
...
<div class="custom-box">
	...
	<div class="column five-sixth last">
		<div class="dt-media-btns-container">
			...
			<a href="#" class="dt-add-video button button-primary"><?php esc_html_e( 'Click Here to Add Video', 'petsworld-core' );?> </a>
		</div>
		<div class="clear"></div>
...
$fields = petsworld_opts_get( 'portfolio-custom-fields', array() );
$fields = array_unique(array_filter($fields));

if(!empty($fields)) : ?>
    <div class="custom-box">
        <div class="column one-sixth">
            <label><?php esc_html_e('Additional Fields','petsworld-core');?></label>
        </div>
        <div class="column five-sixth last">
            <div class="meta-fields">
				<div class="column one-fourth" style="text-align:center;">
                	<strong><?php esc_html_e('Title','petsworld-core');?></strong>
                </div>
                <div class="column three-fourth last">
                	<strong><?php esc_html_e('Value','petsworld-core');?></strong>
                </div>
            ...
            <p class="note"> <?php esc_html_e("Here you can change Additional field title & values for this item.",'petsworld-core');?> </p>
        </div>
    </div><?php
