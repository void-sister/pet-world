<?php
global $post;
$pet_settings = get_post_meta ( $post->ID, '_custom_settings', TRUE );
$pet_settings = is_array ( $pet_settings ) ? $pet_settings : array ();
echo '<input type="hidden" name="dt_theme_pet_meta_nonce" value="'.wp_create_nonce('dt_theme_pet_nonce').'" />'; ?>
...
<div class="sub-title custom-box">
    ...
    <div class="column five-sixth last">
        <div class="two-third column image-preview-container" style="width:60%;">
            <?php $subtitlebg = array_key_exists ( 'sub-title-bg', $pet_settings ) ? $pet_settings ['sub-title-bg'] : '';?>
        ...
        <div class="one-third column last">
            ...
            <?php $opacity =  array_key_exists ( "sub-title-opacity", $pet_settings ) ? $pet_settings ['sub-title-opacity'] : ''; ?>
...
<div class="sub-title custom-box">
    ...
    <div class="column five-sixth last">
        <div class="column one-third">
            ...
            <?php $bgrepeat =  array_key_exists ( "sub-title-bg-repeat", $pet_settings ) ? $pet_settings ['sub-title-bg-repeat'] : ''; ?>
            <div class="clear"></div>
        ...
        <div class="column one-third">
            ...
            <?php $bgposition =  array_key_exists ( "sub-title-bg-position", $pet_settings ) ? $pet_settings ['sub-title-bg-position'] : ''; ?>
            <div class="clear"></div>
        ...
        <?php $label = 		esc_html__('Background Color','petsworld-core');
              ...
              $value =  	array_key_exists ( 'sub-title-bg-color', $pet_settings ) ? $pet_settings ['sub-title-bg-color'] : '';
...
<div id="page-layout" class="custom-box">
    ...
    <div class="column five-sixth last">
        <ul class="bpanel-layout-set"><?php
			...
			$v =  array_key_exists("layout",$pet_settings) ?  $pet_settings['layout'] : 'content-full-width';
...
<?php 
 $sb_layout = array_key_exists("layout",$pet_settings) ? $pet_settings['layout'] : 'content-full-width';
...
<div id="widget-area-options" <?php echo $sidebar_both;?>>
	<div id="left-sidebar-container" class="page-left-sidebar" <?php echo $sidebar_left; ?>>
		...
		<div id="page-commom-sidebar" class="sidebar-section custom-box">
			...
			<div class="column five-sixth last"><?php 
				$switchclass = array_key_exists("show-standard-sidebar-left",$pet_settings) ? 'checkbox-switch-on' :'checkbox-switch-off';
				$checked = array_key_exists("show-standard-sidebar-left",$pet_settings) ? ' checked="checked"' : '';?>
		...
		<div id="page-sidebars" class="sidebar-section custom-box page-widgetareas">
			...
			<div class="column five-sixth last"><?php
				$widgetareas = array_key_exists("widget-area-left",$pet_settings) ? array_unique($pet_settings["widget-area-left"]) : array();
	...
	<div id="right-sidebar-container" class="page-right-sidebar" <?php echo $sidebar_right; ?>>
		...
		<div id="page-commom-sidebar" class="sidebar-section custom-box page-right-sidebar">
			...
			<div class="column five-sixth last"><?php 
				$switchclass = array_key_exists("show-standard-sidebar-right",$pet_settings) ? 'checkbox-switch-on' :'checkbox-switch-off';
				$checked = array_key_exists("show-standard-sidebar-right",$pet_settings) ? ' checked="checked"' : '';?>
		...
		<div id="page-sidebars" class="sidebar-section custom-box page-widgetareas">
			...
			<div class="column five-sixth last"><?php
				$widgetareas = array_key_exists("widget-area-right",$pet_settings) ? array_unique($pet_settings["widget-area-right"]) : array();
				$widgets = petsworld_option('widgetarea','custom');?>
