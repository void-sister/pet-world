<?php global $post;
$vet_settings = get_post_meta ( $post->ID, '_custom_settings', TRUE );
$vet_settings = is_array ( $vet_settings ) ? $vet_settings : array ();
echo '<input type="hidden" name="dt_theme_vet_meta_nonce" value="'.wp_create_nonce('dt_theme_vet_nonce').'" />'; ?>

<!-- Personal Phone -->
<div class="sub-title custom-box">
    <div class="column one-sixth"><?php
        esc_html_e( 'Personal Phone','petsworld-core');
        $personal_phone = array_key_exists ( 'personal_phone', $vet_settings ) ? $vet_settings ['personal_phone'] : '';
        ?></div>
    <div class="column five-sixth last">
        <input name="personal_phone" type="text" class="small" value="<?php echo esc_attr($personal_phone);?>"/>
    </div>
</div>
<!-- Personal Phone -->
...
<div class="sub-title custom-box">
    <div class="column one-sixth"><?php
        esc_html_e( 'Clinic Title','petsworld-core');
        $clinic_title = array_key_exists ( 'clinic_title', $vet_settings ) ? $vet_settings ['clinic_title'] : '';
        ?></div>
    <div class="column five-sixth last">
        <input name="clinic_title" type="text" class="medium" value="<?php echo esc_attr($clinic_title);?>"/>
    </div>
</div>
<!-- Clinic Title -->
...
<div class="sub-title custom-box">
    <div class="column one-sixth"><?php
        esc_html_e( 'Clinic Phone','petsworld-core');
        $clinic_phone = array_key_exists ( 'clinic_phone', $vet_settings ) ? $vet_settings ['clinic_phone'] : '';
        ?></div>
    <div class="column five-sixth last">
        <input name="clinic_phone" type="text" class="small" value="<?php echo esc_attr($clinic_phone);?>"/>
    </div>
</div>
<!-- Clinic Phone -->
...
<div class="sub-title custom-box">
    <div class="column one-sixth"><?php
        esc_html_e( 'Clinic Address','petsworld-core');
        $clinic_address = array_key_exists ( 'clinic_address', $vet_settings ) ? $vet_settings ['clinic_address'] : '';
        ?></div>
    <div class="column five-sixth last">
        <input name="clinic_address" type="text" class="medium" value="<?php echo esc_attr($clinic_address);?>"/>
    </div>
</div>
<!-- Clinic Address -->
...
<div class="sub-title custom-box">
    <div class="column one-sixth"><?php
        ...
        $website_link = array_key_exists ( 'website_link', $vet_settings ) ? $vet_settings ['website_link'] : '';
        ?></div>
    <div class="column five-sixth last">
...
<div class="sub-title custom-box">
    <div class="column one-sixth"><?php
        ...
        $instagram_social_link = array_key_exists ( 'instagram_social_link', $vet_settings ) ? $vet_settings ['instagram_social_link'] : '';
        ?></div>
    <div class="column five-sixth last">
...
<div class="sub-title custom-box">
    <div class="column one-sixth"><?php
        ...
        $facebook_social_link = array_key_exists ( 'facebook_social_link', $vet_settings ) ? $vet_settings ['facebook_social_link'] : '';
        ?></div>
    <div class="column five-sixth last">
...
<div class="sub-title custom-box">
    ...
    <div class="column five-sixth last">
        <div class="two-third column image-preview-container" style="width:60%;">
            <?php $subtitlebg = array_key_exists ( 'sub-title-bg', $vet_settings ) ? $vet_settings ['sub-title-bg'] : '';?>
        ...
        <div class="one-third column last">
            ...
            <?php $opacity =  array_key_exists ( "sub-title-opacity", $vet_settings ) ? $vet_settings ['sub-title-opacity'] : ''; ?>
...
<div class="sub-title custom-box">
    ...
    <div class="column five-sixth last">
        <div class="column one-third">
            ...
            <?php $bgrepeat =  array_key_exists ( "sub-title-bg-repeat", $vet_settings ) ? $vet_settings ['sub-title-bg-repeat'] : ''; ?>
            <div class="clear"></div>
        ...
        <div class="column one-third">
            ...
            <?php $bgposition =  array_key_exists ( "sub-title-bg-position", $vet_settings ) ? $vet_settings ['sub-title-bg-position'] : ''; ?>
            <div class="clear"></div>
        ...
        <div class="column one-third last">
            ...
            $value =  	array_key_exists ( 'sub-title-bg-color', $vet_settings ) ? $vet_settings ['sub-title-bg-color'] : '';
...
<div id="page-layout" class="custom-box">
    ...
    <div class="column five-sixth last">
        <ul class="bpanel-layout-set"><?php
            ...
            $v =  array_key_exists("layout",$vet_settings) ?  $vet_settings['layout'] : 'content-full-width';
...
<?php
$sb_layout = array_key_exists("layout",$vet_settings) ? $vet_settings['layout'] : 'content-full-width';
...
<div id="widget-area-options" <?php echo $sidebar_both;?>>
    <div id="left-sidebar-container" class="page-left-sidebar" <?php echo $sidebar_left; ?>>
        ...
        <div id="page-commom-sidebar" class="sidebar-section custom-box">
            ...
            <div class="column five-sixth last"><?php
                $switchclass = array_key_exists("show-standard-sidebar-left",$vet_settings) ? 'checkbox-switch-on' :'checkbox-switch-off';
                $checked = array_key_exists("show-standard-sidebar-left",$vet_settings) ? ' checked="checked"' : '';?>
        ...
        <div id="page-sidebars" class="sidebar-section custom-box page-widgetareas">
            ...
            <div class="column five-sixth last"><?php
                $widgetareas = array_key_exists("widget-area-left",$vet_settings) ? array_unique($vet_settings["widget-area-left"]) : array();
    ...
    <div id="right-sidebar-container" class="page-right-sidebar" <?php echo $sidebar_right; ?>>
        ...
        <div id="page-commom-sidebar" class="sidebar-section custom-box page-right-sidebar">
            ...
            <div class="column five-sixth last"><?php
                $switchclass = array_key_exists("show-standard-sidebar-right",$vet_settings) ? 'checkbox-switch-on' :'checkbox-switch-off';
                $checked = array_key_exists("show-standard-sidebar-right",$vet_settings) ? ' checked="checked"' : '';?>
        ...
        <div id="page-sidebars" class="sidebar-section custom-box page-widgetareas">
            ...
            <div class="column five-sixth last"><?php
                $widgetareas = array_key_exists("widget-area-right",$vet_settings) ? array_unique($vet_settings["widget-area-right"]) : array();
                $widgets = petsworld_option('widgetarea','custom');?>
    ...
    <div class="column five-sixth last">
        ...
        <div class="dt-media-container">
            <ul class="dt-items-holder"><?php
                if (array_key_exists ( "items", $vet_settings )) {
                    foreach ( $vet_settings ["items_thumbnail"] as $key => $thumbnail ) {
                        $item = $vet_settings ['items'] [$key];
                        $out = "";
                        $name = "";
                        ...
                        if (in_array ( $ext, $foramts )) {
                            $name = $vet_settings ['items_name'] [$key];
                            $out .= "<li>";
