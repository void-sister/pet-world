...
if (! class_exists ( 'DTPortfolioPostType' )) {
	class DTPortfolioPostType {
		...
		function createPostType() {
			...
			$tagslug  = 'portfolio_tags';

			if( function_exists( 'petsworld_opts_get' ) ) {
				$portslug =	petsworld_opts_get( 'single-portfolio-slug', 'dt_portfolios' );
				$taxslug  =	petsworld_opts_get( 'portfolio-category-slug', 'portfolio_entries' );
				$tagslug  =	petsworld_opts_get( 'portfolio-tag-slug', 'portfolio_tags' );
			}

			$labels = array (
					'name' => __ ( 'Portfolios', 'petsworld-core' ),
					'all_items' => __ ( 'All Portfolios', 'petsworld-core' ),
					'singular_name' => __ ( 'Portfolio', 'petsworld-core' ),
					'add_new' => __ ( 'Add New', 'petsworld-core' ),
					'add_new_item' => __ ( 'Add New Portfolio', 'petsworld-core' ),
					'edit_item' => __ ( 'Edit Portfolio', 'petsworld-core' ),
					'new_item' => __ ( 'New Portfolio', 'petsworld-core' ),
					'view_item' => __ ( 'View Portfolio', 'petsworld-core' ),
					'search_items' => __ ( 'Search Portfolios', 'petsworld-core' ),
					'not_found' => __ ( 'No Portfolios found', 'petsworld-core' ),
					'not_found_in_trash' => __ ( 'No Portfolios found in Trash', 'petsworld-core' ),
					'parent_item_colon' => __ ( 'Parent Portfolio:', 'petsworld-core' ),
					'menu_name' => __ ( 'Portfolios', 'petsworld-core' ) ,					
			);
			
			$args = array (
					'labels' => $labels,
					'hierarchical' => false,
					'description' => __( 'This is custom post type portfolios', 'petsworld-core' ),
					'supports' => array (
							'title',
							'editor',
							'comments',
			...
			register_taxonomy ( 'portfolio_entries', array (
				'dt_portfolios' 
					...
					"hierarchical" => true,
					"label" => esc_html__( "Categories",'petsworld-core' ),
					"singular_label" => esc_html__( "Category",'petsworld-core' ),
			...
			register_taxonomy ( 'portfolio_tags', array (
				'dt_portfolios' 
					...
					"label" => esc_html__( 'Tags','petsworld-core' ),
					"singular_label" => esc_html__( 'Tag','petsworld-core' ),
					"show_admin_column" => true,
		...
		function dt_add_portfolio_meta_box() {
			add_meta_box ( "dt-portfolio-default-metabox", __ ( 'Default Options', 'petsworld-core' ), array (
					$this,
					'dt_default_metabox' 
		...
		function dt_portfolios_edit_columns($columns) {
			...
			$newcolumns = array (
				...
				"dt_portfolio_thumb" => __("Image", 'petsworld-core'),
				"title" => __("Title", 'petsworld-core'),
				"author" => __("Author", 'petsworld-core')
			);
