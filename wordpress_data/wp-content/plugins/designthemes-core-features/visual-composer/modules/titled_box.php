...
function dt_sc_titled_box_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( "Title boxes", 'petsworld-core' ),
    "base" => "dt_sc_titled_box",
      ...
      array(
        ...
        'admin_label' => true,
        'value' => array(
          esc_html__('Titled Box','petsworld-core')  => 'titled-box',
          esc_html__('Error Box','petsworld-core')  => 'error-box',
          esc_html__('Warning Box','petsworld-core')  => 'warning-box',
          esc_html__('Success Box','petsworld-core')  => 'success-box',
          esc_html__('Info Box','petsworld-core')  => 'info-box'
        ),
        'std' => 'titled-box'
      ),
      ...
      array(
        "type" => "colorpicker",
        "heading" => esc_html__( "Content color", 'petsworld-core' ),
