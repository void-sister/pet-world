...
function dt_sc_accordion_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( "Accordions", 'petsworld-core' ),
		"base" => "dt_sc_accordion",
		"category" => DT_VC_CATEGORY,
		"show_settings_on_create" => false,
		"is_container" => true,
		"icon" => "dt_sc_accordion",
		'description' => esc_html__( 'Collapsible content panels', 'petsworld-core' ),
		"params" => array(
			...
			array(
				...
				'description' => esc_html__( 'Select accordion display style', 'petsworld-core' )
			),
			...
			array(
				...
				'description' => esc_html__( 'Select standard accordion display type', 'petsworld-core' ),
			...
			array(
				...
				'heading' => esc_html__( 'Type', 'petsworld-core' ),
				'description' => esc_html__( 'Select framed accordion display type', 'petsworld-core' ),
		...
		'custom_markup' => '<div class="wpb_accordion_holder wpb_holder clearfix vc_container_for_children">%content%</div>
			<div class="tab_controls">
				<a class="add_tab" title="' . esc_attr__( 'Add section', 'petsworld-core' ) . '">
				<span class="vc_icon"></span> <span class="tab-label">' . esc_html__( 'Add section', 'petsworld-core' ) . '</span></a>
			</div>',
		'default_content' => '[dt_sc_accordion_tab title="' . esc_html__( 'Section 1', 'petsworld-core' ) . '"][/dt_sc_accordion_tab]
			[dt_sc_accordion_tab title="' . esc_html__( 'Section 2', 'petsworld-core' ) . '"][/dt_sc_accordion_tab]'			
	) );
